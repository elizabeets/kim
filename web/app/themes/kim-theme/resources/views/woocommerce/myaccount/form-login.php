...
<?php if (get_option('woocommerce_enable_myaccount_registration') === 'yes') : ?>
    ...
    <div class="row">
        <div class="col-12 text-center text-sm-left mb-3 mb-sm-0">
            <h3>
                <?php the_field('shop_welcome_title', 'option'); ?>
            </h3>
            <?php the_field('shop_welcome_text', 'option'); ?>
        </div>
    </div>
...
<div class="row" id="customer_login">
    ...
    <div class="col-12 col-md-6">
        ...
        <form class="woocomerce-form woocommerce-form-login login" method="post">
            ...
            <p class="form-row">
                ...
                <input type="submit" class="woocommerce-Button btn btn-outline-primary" name="login"
    ...
    <div class="col-12 col-md-6">
        ...
        <h4><?php _e('Join Today', 'woocommerce'); ?></h4>
        ...
        <form method="post" class="register">
            ...
            <p class="woocomerce-FormRow form-row">
                ...
                <input type="submit" class="woocommerce-Button btn btn-outline-primary" name="register"
